<?php
    ...
    for($i=0;$i<$num_rows;$i++){
        ...
        $response[]=array("itemID"=>$row['itemID'],"itemName"=>$row['itemName'],"typeID"=>$row['typeID'],"typeProduct"=>$row['typeProduct'],"price"=>$row['price'],"city"=>$row['city'],"description"=>$row['description'],"photo1"=>$row['photo1'],"date"=>$row['date'],"Action"=>$row['itemID']);
    }
//    var_dump($response);
